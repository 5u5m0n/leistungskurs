...
public class Gegner extends Wesen{
    ...
    public Gegner(int level, int staerke, int konstitution, int mStaerke, int mVerteidigung, int maxHP, int maxSP, int geschwindigkeit, int glueck, int xpDrop) {
        this.setLevel(level);
        this.setStaerke(staerke);
        this.setKonstitution(konstitution);
        this.setMStaerke(mStaerke);
        this.setMVerteidigung(mVerteidigung);
        this.setMaxHP(maxHP);
        this.setMaxSP(maxSP);
