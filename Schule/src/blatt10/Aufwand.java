...
public class Aufwand {
    ...
    /* a)
        Das Programm fügt nach jedem '. ' einen Zeilenumbruch ein.
     */
    /* d)
        Das programm ist Stabil
     */
    /* e)
        Der Speicheraufwand steigt, wenn 'eingabe' länger wird. Der Best-Case ist also, wenn 'eingabe' eine Länge von 0 hat. Einen Worst-Case gibt es daher nicht wirklich.
     */
